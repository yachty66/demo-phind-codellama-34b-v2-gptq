...
# Banana.dev Phind-CodeLlama-34B-v2-GPTQ starter template

This is a Phind-CodeLlama-34B-v2-GPTQ starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/yachty66/demo-phind-codellama-34b-v2-gptq/fork) repository to your own Github account.
